...
export function LegalPage() {
    ...
    return (
        <div className="min-h-screen bg-[#FAF8F5]">
            {/* Hero Section */}
            <section className="relative bg-gradient-to-b from-[#F5F0EB] to-[#FAF8F5] border-b border-[#E0D6CC] py-16">
            ...
            <nav className="max-w-7xl mx-auto px-4 py-6 text-sm font-sans-elegant">
                ...
                <span className="text-[#7A6B5A]">Legal</span>
            </nav>

            {/* Tabs Navigation */}
            <section className="bg-white border-b border-[#E0D6CC] sticky top-0 z-10">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="flex gap-0 overflow-x-auto">
                        <button
                            ...
                            className={`py-4 px-6 font-sans-elegant text-sm tracking-wide border-b-2 transition whitespace-nowrap ${
                                activeTab === 'privacy'
                                    ? 'border-[#8B7355] text-[#8B7355]'
                                    : 'border-transparent text-[#7A6B5A] hover:text-[#8B7355]'
                            }`}
                        >
                            Privacidad
                        </button>
            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                ...
                {activeTab === 'privacy' && (
                    <div id="privacy" className="space-y-8">
                        <div className="bg-white border border-[#E0D6CC] p-8 md:p-10">
                            ...
                            <p className="text-sm text-[#A69580] font-sans-elegant mb-8">
                                Última actualización: Diciembre 2025
                            </p>

                            <div className="space-y-8">
                                <section>
                                    <h3 className="text-lg font-sans-elegant font-medium text-[#2C2420] mb-4 uppercase tracking-wide">
                                        1. Introducción
                                    </h3>
                                ...
                                <section>
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-3">
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F0F5F0] border border-[#6B8E6B]/30 p-5">
                                        <p className="font-sans-elegant font-medium text-[#6B8E6B] mb-3">✓ Medidas de Seguridad:</p>
                                        <ul className="space-y-2 text-[#5C4D3C] font-sans-elegant text-sm">
                                ...
                                <section>
                                    ...
                                    <p className="text-[#5C4D3C] font-sans-elegant leading-relaxed mb-4">Tienes derecho a:</p>
                                    <ul className="space-y-2 text-[#5C4D3C] font-sans-elegant">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#8B7355]">•</span>
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-5">
                                        <p className="font-sans-elegant font-medium text-[#2C2420]">Pascale Closet</p>
                                        <p className="text-[#5C4D3C] font-sans-elegant text-sm mt-1">Email: privacy@pascalecloset.com</p>
                                    </div>
                                </section>
                            </div>
                        </div>
                        ...
                        <div className="bg-white border border-[#E0D6CC] p-8 md:p-10">
                            ...
                            <div className="space-y-8">
                                ...
                                <section>
                                    ...
                                    <ul className="space-y-2 text-[#5C4D3C] font-sans-elegant mb-4">
                                        <li className="flex items-start gap-2">
                                    ...
                                    <p className="text-[#5C4D3C] font-sans-elegant leading-relaxed mb-4">No puedes:</p>
                                    <ul className="space-y-2 text-[#5C4D3C] font-sans-elegant">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#B85450]">✕</span>
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#FDF8F0] border border-[#E8DED0] p-5 space-y-4">
                                        <div>
                                            <p className="font-sans-elegant font-medium text-[#8B7355] mb-2">Como Compradora:</p>
                                            <ul className="space-y-1 text-[#5C4D3C] font-sans-elegant text-sm">
                                        ...
                                        <div>
                                            <p className="font-sans-elegant font-medium text-[#8B7355] mb-2">Como Vendedora:</p>
                                            <ul className="space-y-1 text-[#5C4D3C] font-sans-elegant text-sm">
                                ...
                                <section>
                                    ...
                                    <p className="text-[#5C4D3C] font-sans-elegant leading-relaxed mb-4">Está prohibido:</p>
                                    <ul className="space-y-2 text-[#5C4D3C] font-sans-elegant">
                                        <li className="flex items-start gap-2">
                                            <span className="text-[#8B7355]">•</span>
                            ...
                            <div className="space-y-8">
                                ...
                                <section>
                                    ...
                                    <div className="space-y-4">
                                        <div className="border-l-2 border-[#8B7355] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies Esenciales</h4>
                                            <p className="text-[#5C4D3C] font-sans-elegant text-sm">Necesarias para el funcionamiento básico del sitio (autenticación, seguridad).</p>
                                            <p className="text-xs text-[#A69580] font-sans-elegant mt-1">No se pueden desactivar en nuestros sistemas.</p>
                                        </div>
                                        <div className="border-l-2 border-[#6B8E6B] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies de Rendimiento</h4>
                                            <p className="text-[#5C4D3C] font-sans-elegant text-sm">Recopilan información sobre cómo usas el sitio (páginas visitadas, errores).</p>
                                            <p className="text-xs text-[#A69580] font-sans-elegant mt-1">Nos ayudan a mejorar la plataforma.</p>
                                        </div>
                                        <div className="border-l-2 border-[#C9B8A8] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies de Funcionalidad</h4>
                                            <p className="text-[#5C4D3C] font-sans-elegant text-sm">Recuerdan tus preferencias y personalizaciones.</p>
                                            <p className="text-xs text-[#A69580] font-sans-elegant mt-1">Ejemplo: idioma preferido, modo oscuro.</p>
                                        </div>
                                        <div className="border-l-2 border-[#C4A574] pl-4 py-2">
                                            <h4 className="font-sans-elegant font-medium text-[#2C2420] mb-1">Cookies de Marketing</h4>
                                            <p className="text-[#5C4D3C] font-sans-elegant text-sm">Rastrean tu actividad para mostrar anuncios relevantes.</p>
                                            <p className="text-xs text-[#A69580] font-sans-elegant mt-1">Se utilizan servicios de terceros como Google Analytics.</p>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section>
                                    ...
                                    <div className="bg-[#F5F0EB] border border-[#E0D6CC] p-5 space-y-3">
                                        <div className="flex justify-between items-center py-2 border-b border-[#E0D6CC]">
                                            <span className="font-sans-elegant font-medium text-[#2C2420]">Google Analytics</span>
                                            <span className="text-[#7A6B5A] font-sans-elegant text-xs">Análisis de tráfico</span>
                                        </div>
                                        <div className="flex justify-between items-center py-2 border-b border-[#E0D6CC]">
                                            <span className="font-sans-elegant font-medium text-[#2C2420]">Stripe</span>
                                            <span className="text-[#7A6B5A] font-sans-elegant text-xs">Procesamiento de pagos</span>
                                        </div>
                                        <div className="flex justify-between items-center py-2">
                                            <span className="font-sans-elegant font-medium text-[#2C2420]">Meta Pixel</span>
                                            <span className="text-[#7A6B5A] font-sans-elegant text-xs">Publicidad</span>
                                        </div>
                                    </div>
                                </section>
                            </div>
                ...
                <div className="mt-12 bg-[#8B7355] p-8 md:p-10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                        ...
                        <div className="flex gap-4 flex-wrap justify-center">
                            <Link 
                                to="/help" 
                                className="px-6 py-3 bg-white text-[#8B7355] font-sans-elegant text-sm tracking-wide hover:bg-[#FAF8F5] transition-all duration-200"
                            >
                                Centro de Ayuda
                            </Link>
                            <a 
                                href="mailto:legal@pascalecloset.com" 
                                className="px-6 py-3 border border-white text-white font-sans-elegant text-sm tracking-wide hover:bg-white hover:text-[#8B7355] transition-all duration-200"
                            >
                                Contactar
                            </a>
                        </div>
